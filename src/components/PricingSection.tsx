...
const PricingSection = () => {
  const plans = [{
    ...
    limitations: ["لا يشمل التقارير الاستراتيجية", "لا يشمل لوحة البيانات"],
    ...
    icon: TrendingUp,
    features: ["10 تحليلات يومية", "مقالات غير محدودة", "أرشيف المحتوى", "فلترة حسب القطاعات", "دعم أولوية"],
    limitations: ["لا يشمل التقارير الاستراتيجية", "لا يشمل لوحة البيانات"],
    ...
    icon: Crown,
    features: ["تحليلات غير محدودة", "جميع التقارير الاستراتيجية", "تحميل المحتوى كـ PDF", "تحليلات قطاعية متخصصة", "دعم مباشر 24/7", "تنبيهات فورية", "🚀 الوصول إلى QIRAA Signals", "📊 عرض شهري وسنوي للبيانات", "📈 رسوم بيانية تفاعلية", "📄 تصدير البيانات CSV"],
    limitations: [],
    ...
    icon: Building2,
    features: ["جميع مزايا الاحترافية", "🧠 AI Insights & Forecasting", "🔄 مقارنة حتى 5 شركات", "📊 تحليل الحصة السوقية", "🌍 مؤشرات متعددة الدول", "⚡ تحديث البيانات الأولوي", "🔗 واجهة API متقدمة", "🎯 تقارير مخصصة", "👨‍💼 مدير حساب مخصص", "🎓 تدريب الفريق", "🔗 تكامل مع أنظمة CRM"],
    limitations: [],
