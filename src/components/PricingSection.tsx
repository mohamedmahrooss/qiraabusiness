...
const PricingSection = () => {
  const plans = [{
    ...
    icon: Crown,
    features: ["تحليلات غير محدودة", "جميع التقارير الاستراتيجية", "تحميل المحتوى كـ PDF", "تحليلات قطاعية متخصصة", "دعم مباشر 24/7", "تنبيهات فورية"],
    limitations: [],
    ...
    icon: Building2,
    features: ["جميع مزايا الاحترافية", "لوحة بيانات مخصصة", "واجهة API متقدمة", "تقارير مخصصة", "مدير حساب مخصص", "تدريب الفريق", "تكامل مع أنظمة CRM"],
    limitations: [],
