  ...
  const plans = [
    {
      ...
      features: [
        "3 تحليلات يومية",
        "20 مقال شهرياً",
        "الوصول للمحتوى العام",
        "دعم عبر البريد الإلكتروني",
      ],
      limitations: [
        "لا يشمل التقارير الاستراتيجية",
        "لا يشمل لوحة البيانات",
      ],
    ...
    },
    {
      ...
      features: [
        "تحليلات غير محدودة",
        "جميع التقارير الاستراتيجية",
        "تحميل المحتوى كـ PDF",
        "تحليلات قطاعية متخصصة",
        "دعم مباشر 24/7",
        "تنبيهات فورية",
      ],
      limitations: [],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex justify-center space-x-8">
            ...
            <div className="flex items-center space-x-2">
              <Check className="h-4 w-4 text-success" />
              <span className="text-sm">دعم فني مجاني</span>
            </div>
          </div>
        </div>
      </div>
